...
type CampusType = 'SGW' | 'LOY'; // Define a type for campus to ensure only these two values are valid
...
const CAMPUS_COORDINATES: { [key in CampusType]: { lat: number, lng: number } } = {
    ...
    LOY: { lat: 45.4583, lng: -73.6403 }
};

// Define the building data
const BUILDINGS = [
    { campus: 'LOY', abbreviation: 'AD', name: 'Administration Building', lat: 45.457984, lng: -73.639834 },
    { campus: 'SGW', abbreviation: 'B', name: 'B Annex', lat: 45.497856, lng: -73.579588 },
    { campus: 'LOY', abbreviation: 'BB', name: 'BB-BH Annex', lat: 45.459793, lng: -73.639174 },
    { campus: 'LOY', abbreviation: 'BH', name: 'BB-BH Annex', lat: 45.459819, lng: -73.639152 },
    { campus: 'LOY', abbreviation: 'CC', name: 'Central Building', lat: 45.458204, lng: -73.640300 },
    { campus: 'SGW', abbreviation: 'CI', name: 'CI Annex', lat: 45.497467, lng: -73.579925 },
    { campus: 'LOY', abbreviation: 'CJA', name: 'Communication Studies and Journalism Building', lat: 45.457478, lng: -73.640354 },
    { campus: 'LOY', abbreviation: 'CJN', name: 'Communication Studies and Journalism Building', lat: 45.457478, lng: -73.640354 },
    { campus: 'LOY', abbreviation: 'CJS', name: 'Communication Studies and Journalism Building', lat: 45.457478, lng: -73.640354 },
    ...
    { campus: 'LOY', abbreviation: 'FC', name: 'F.C. Smith Building', lat: 45.458493, lng: -73.639287 },
    ...
    { campus: 'LOY', abbreviation: 'GE', name: 'Centre for Structural and Functional Genomics', lat: 45.457017, lng: -73.640432 },
    ...
    { campus: 'LOY', abbreviation: 'HA', name: 'Hingston Hall, wing HA', lat: 45.459356, lng: -73.641270 },
    { campus: 'LOY', abbreviation: 'HB', name: 'Hingston Hall, wing HB', lat: 45.459308, lng: -73.641849 },
    { campus: 'LOY', abbreviation: 'HC', name: 'Hingston Hall, wing HC', lat: 45.459663, lng: -73.642080 },
    { campus: 'LOY', abbreviation: 'HU', name: 'Applied Science Hub', lat: 45.458513, lng: -73.641921 },
    { campus: 'LOY', abbreviation: 'JR', name: 'Jesuit Residence', lat: 45.458432, lng: -73.643235 },
    ...
    { campus: 'LOY', abbreviation: 'PB', name: 'PB Building', lat: 45.456534, lng: -73.638106 },
    { campus: 'LOY', abbreviation: 'PC', name: 'PERFORM centre', lat: 45.457088, lng: -73.637683 },
    { campus: 'SGW', abbreviation: 'PR', name: 'PR Annex', lat: 45.497066, lng: -73.579790 },
    { campus: 'LOY', abbreviation: 'PS', name: 'Physical Services Building', lat: 45.459636, lng: -73.639758 },
    { campus: 'LOY', abbreviation: 'PT', name: 'Oscar Peterson Concert Hall', lat: 45.459308, lng: -73.638941 },
    { campus: 'LOY', abbreviation: 'PY', name: 'Psychology Building', lat: 45.458938, lng: -73.640467 },
    ...
    { campus: 'LOY', abbreviation: 'RA', name: 'Recreation and Athletics Complex', lat: 45.456774, lng: -73.637610 },
    { campus: 'LOY', abbreviation: 'RF', name: 'Loyola Jesuit Hall and Conference Centre', lat: 45.458489, lng: -73.641028 },
    ...
    { campus: 'LOY', abbreviation: 'SC', name: 'Student Centre', lat: 45.459131, lng: -73.639251 },
    { campus: 'LOY', abbreviation: 'SH', name: 'Solar House', lat: 45.459298, lng: -73.642478 },
    { campus: 'LOY', abbreviation: 'SP', name: 'Richard J. Renaud Science Complex', lat: 45.457881, lng: -73.641565 },
    { campus: 'SGW', abbreviation: 'T', name: 'T Annex', lat: 45.496710, lng: -73.579270 },
    { campus: 'LOY', abbreviation: 'TA', name: 'Terrebonne Building', lat: 45.459992, lng: -73.640897 },
    { campus: 'LOY', abbreviation: 'TB', name: 'TB Annex', lat: 45.460051, lng: -73.640842 },
    ...
    { campus: 'LOY', abbreviation: 'VE', name: 'Vanier Extension', lat: 45.459026, lng: -73.638606 },
    { campus: 'LOY', abbreviation: 'VL', name: 'Vanier Library Building', lat: 45.459026, lng: -73.638606 },
